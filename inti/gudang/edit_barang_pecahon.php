...
// Ambil data barang dari tabel gudang_pecahon
$barang_sql = "SELECT gp.* FROM gudang_pecahon gp WHERE gp.id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($error)) {
        // Update semua kolom di tabel gudang_pecahon
        ...
        if ($update_stmt) {
            ...
            $update_stmt->bind_param("sdiisssiii",
                $nama_barang,
                $harga_ambil,
                $qty,
                $max_order,
            ...
            if ($update_stmt->execute()) {
                ...
                header("Location: /?path=gudang_pecahon&success=Barang berhasil diperbarui");
                exit;
            } else {
    ...
    <div class="container">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="/?path=gudang_pecahon" class="btn btn-light btn-sm">
